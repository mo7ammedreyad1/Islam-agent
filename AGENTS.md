...
> ما الرندر يخلص أصلًا، حتى لو باقي الكود كله صح 100%. اكتب السكريبت اللي تحت
> **بفهم كامل لكل جزء فيه**، مطابقًا له وظيفيًا بالكامل من غير حذف أو اختصار،
> وخصوصًا الـ `timeout` ده.
>
